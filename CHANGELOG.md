...
* add opl queue for sequential render jobs ([7364f8c](https://github.com/nicolasgalvez/opl3-duo-midi/commit/7364f8c6e2efb1893ef92ed699be56e99b9e10bf))
* add opl queue for sequential render jobs ([1e0c7b5](https://github.com/nicolasgalvez/opl3-duo-midi/commit/1e0c7b541ec9cb342e5cbd5bc2475d0063a37cc2))
* **midi:** --pc flag on note/chord/scale to pick the gm instrument ([337e609](https://github.com/nicolasgalvez/opl3-duo-midi/commit/337e609587f5abcfada7d02088dba5febe3560b1))
...
* **midi:** add VGM (native OPL2/OPL3) playback ([820fea7](https://github.com/nicolasgalvez/opl3-duo-midi/commit/820fea71e55a600ef349845bb1248d659b836bcd))
* **midi:** add VGM (native OPL2/OPL3) playback (ODM-15) ([bb23481](https://github.com/nicolasgalvez/opl3-duo-midi/commit/bb234812f5ce878b3c518299b7a14b22c6e9f868))
...
* **midi:** opl queue stop/clear, and clean render interrupt handling ([bf3fe9d](https://github.com/nicolasgalvez/opl3-duo-midi/commit/bf3fe9d2cfa2460453ca491b6d5ea7a03b901d9e))
* **midi:** opl queue stop/clear, and clean render interrupt handling ([657ce4a](https://github.com/nicolasgalvez/opl3-duo-midi/commit/657ce4ae5988590be11b0f1e75dd97697ed9e752))
...
* **midi:** top-level --device flag + warning on silent port fallback ([9fa8f90](https://github.com/nicolasgalvez/opl3-duo-midi/commit/9fa8f9041dfbed08646370ca49a87f1b856c6715))
...
* **ci:** all-userspace linux render e2e — pulse null sink + udp midi bridge ([2b9a951](https://github.com/nicolasgalvez/opl3-duo-midi/commit/2b9a95153f3176c04e81fc09b2fe3d0b9d63b1a1))
...
* **midi:** apply the VGM equalizer fix to the render page too ([127b2ea](https://github.com/nicolasgalvez/opl3-duo-midi/commit/127b2eaf51e5c0acd96b87dfcfc3acd1910cc468))
* **midi:** apply the VGM equalizer fix to the render page too ([e52afab](https://github.com/nicolasgalvez/opl3-duo-midi/commit/e52afabee9bbcea7ef56b788f9fc36e0e99bb9b8))
...
* **midi:** drive the web equalizer from VGM raw register writes ([58ede3a](https://github.com/nicolasgalvez/opl3-duo-midi/commit/58ede3a4b116aa7724c9ff24596f8b6a7ba52ca2))
* **midi:** drive the web equalizer from VGM raw register writes too ([a7517ec](https://github.com/nicolasgalvez/opl3-duo-midi/commit/a7517ec4c63179bbc05cfa3c4f2d72794a8af144))
* **midi:** flush queued udp datagrams before closing the midi socket ([3b95649](https://github.com/nicolasgalvez/opl3-duo-midi/commit/3b956493d2c1f00db0acac76aeabf0c3978318b3))
* **midi:** scope CC120/121/123 per-channel, apply pitch bend on note-on ([78d61e5](https://github.com/nicolasgalvez/opl3-duo-midi/commit/78d61e5a74674ca79b325889889255ffd2650111))
* **midi:** scope CC120/121/123 per-channel, apply pitch bend on note-on ([06acadc](https://github.com/nicolasgalvez/opl3-duo-midi/commit/06acadcc72625ac647b79d3a9bca54e3257aacac))
...
* **midi:** validate musical cli args instead of sending nan to the synth ([0be9cd3](https://github.com/nicolasgalvez/opl3-duo-midi/commit/0be9cd388bb72a1597af7fb3d60f4def7d29d4bc))
* **midi:** wake before sending patch changes ([96e64cc](https://github.com/nicolasgalvez/opl3-duo-midi/commit/96e64ccbbe0c712b80549add219aa6c687b61285))
* **midi:** wake before sending patch changes ([27d2a64](https://github.com/nicolasgalvez/opl3-duo-midi/commit/27d2a641de911a9057a701545868d1bc54f54006))
* **ODM-26:** stop the LFO re-pitching notes that have been released ([#65](https://github.com/nicolasgalvez/opl3-duo-midi/issues/65)) ([fe7d992](https://github.com/nicolasgalvez/opl3-duo-midi/commit/fe7d9920b04e78147038e863c22a0034e330526d))
* **ODM-27:** take the drum note base from the table it indexes ([#66](https://github.com/nicolasgalvez/opl3-duo-midi/issues/66)) ([1500f04](https://github.com/nicolasgalvez/opl3-duo-midi/commit/1500f04f61efbd55dd1fb72763a3d0e272571b46))
...
* value-initialise the MIDI channel state ([ff0ee94](https://github.com/nicolasgalvez/opl3-duo-midi/commit/ff0ee94527e3fa8cad463b546e49dcdd64861b8b))
